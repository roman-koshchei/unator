...
static async Task SendText(HttpListenerContext ctx, string text)
{
...
static async Task<string> ReadTextAsync(HttpListenerContext ctx)
{
...
static int IsAuthorized(HttpListenerContext ctx)
{
